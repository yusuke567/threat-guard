    ...
    <nav className="bg-white border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {user?.role === 'admin' && (
            <a href="/admin/organizations" className="text-gray-600 hover:text-gray-900 font-medium text-sm">管理</a>
          )}
          {user && (
      ...
      {open && (
        <div className="md:hidden mt-3 pt-3 border-t border-gray-200 space-y-2">
          ...
          {user?.role === 'admin' && (
            <a href="/admin/organizations" className="block py-2 text-gray-700 hover:text-gray-900 font-medium text-sm">管理</a>
          )}
          {user && (
